const Input = ({ label, placeholder, type, step, value, handleChange }) => {
  return (
    <>
      <label className='text-gray-400 ml-2'>{label}:</label> 
      <div className='dark:bg-[#212226] rounded-lg border px-1 py-2 focus:shadow-md dark:border-transparent dark:bg-[#333333]'>
